#ifndef __BOBLIEW_SOCKET_H__
#define __BOBLIEW_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(bobliew::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(bobliew::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(bobliew::Address::ptr address);
