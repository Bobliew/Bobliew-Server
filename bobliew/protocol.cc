...
bool Request::parserFromByteArray(ByteArray::ptr bytearray) {
...
bool Response::parserFromByteArray(ByteArray::ptr bytearray) {
    m_sn = bytearray->readUint32();
    m_cmd = bytearray->readUint32();
...
bool Notify::parserFromByteArray(ByteArray::ptr bytearray) {
