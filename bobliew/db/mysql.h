#ifndef __BOBLIEW__DB_MYSQL_H__
#define __BOBLIEW__DB_MYSQL_H__
...
bool mysql_time_to_time(const MYSQL_TIME& mt, time_t& ts);
...
public:
    ...
    bobliew::IStmt::ptr prepare(const std::string& sql) override;
...
class MySQLManager {
public:
    typedef bobliew::Mutex MutexType;
...
typedef bobliew::Singleton<MySQLManager> MySQLMgr;
