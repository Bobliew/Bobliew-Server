...
int32_t FunctionServlet::handle(bobliew::http::HttpRequest::ptr request,
...
ServletDispatch::ServletDispatch() :Servlet("ServletDispatch") {
    m_default.reset(new NotFoundServlet("bobliew/1.0"));
}

int32_t ServletDispatch::handle(bobliew::http::HttpRequest::ptr request,
                       bobliew::http::HttpResponse::ptr response,
                       bobliew::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(bobliew::http::HttpRequest::ptr request
                   , bobliew::http::HttpResponse::ptr response
                   , bobliew::http::HttpSession::ptr session) {
    response->setStatus(bobliew::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "bobliew/1.0.0");
