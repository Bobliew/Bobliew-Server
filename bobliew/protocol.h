#ifndef __BOBLIEW_PROTOCOL_H__
#define __BOBLIEW_PROTOCOL_H__
...
public:
    ...
    virtual bool parserFromByteArray(ByteArray::ptr bytearray) = 0;
...
public:
    ...
    virtual Message::ptr parserFrom(Stream::ptr stream) = 0;
...
public:
    ...
    virtual bool parserFromByteArray(ByteArray::ptr bytearray) override;
protected:
    uint32_t m_sn;
    uint32_t m_cmd;
};
...
virtual bool serializeToByteArray(ByteArray::ptr bytearray) override;
virtual bool parserFromByteArray(ByteArray::ptr byrearray) override;
